...
class Engine {
    ...
    afterLoadInitialization() {
        ...
        //creates shader program
        {
            ...
            let fsSource = "precision mediump float; varying vec2 vTextureCoord; varying vec3 vNormal; uniform sampler2D uSampler; void main() {float diff = max(dot(vNormal, normalize(vec3(0.25, 1.0, 0.25)) ), 0.0); gl_FragColor = texture2D(uSampler, vTextureCoord) * (diff + 0.5);}";
